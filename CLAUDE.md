...
| 変更内容 | 更新するファイル |
|---|---|
| アーキテクチャ・技術選定の変更 | `docs/02-architecture.md`、`README.md` |
| CDK スタック構成の変更 | `docs/03-cdk-stack-design.md`、`CLAUDE.md`（CDK スタックセクション） |
| バッチ処理フローの変更 | `docs/04-batch-design.md` |
| DB テーブル・カラムの変更 | `docs/05-database-design.md` |
| CI/CD パイプラインの変更 | `docs/06-cicd-design.md` |
| 運用手順・監視設定の変更 | `docs/07-operation-design.md` |
| ステップ完了・問題発生 | `docs/development-plan.md`（チェックボックス・備考・トラブルシューティングログ） |
| リポジトリ構成の変更 | `CLAUDE.md`（リポジトリ構成セクション）、`README.md` |
