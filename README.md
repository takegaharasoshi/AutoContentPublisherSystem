...
体系の全体像は [docs/index.html](docs/index.html) を参照。開発計画・進捗は [docs/plans/development-plan.html](docs/plans/development-plan.html) で管理し、完了ステップの実施記録は [docs/plans/development-log.html](docs/plans/development-log.html) に保管する。
