...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'logic-training-1'),
        ...
        'L1', 'deep',
        '男は車で移動している。移動中、道の途中で止まり、子どもが生まれた。男は少しも慌てず、その子を車に乗せ、病院に寄らずに移動を続けた。なぜ?',
        '人生ゲームの車の駒だった',
        '{"hook":"父親、落ち着きすぎでは?","hint":"その道、マス目でできてないか?","question":"男は車で移動している。移動中、道の途中で止まり、子どもが生まれた。男は少しも慌てず、その子を車に乗せ、病院に寄らずに移動を続けた。なぜ?","answer":"人生ゲームの車の駒だった","explanation":"男の車は人生ゲームの駒。子どもが生まれるマスに止まったら、小さなピンを車の穴に差して家族が増える。病院に寄らずに移動を続けるのも当然だ。","coach_comment":"盤の上の話と見抜けたか!","tags":["水平思考","夜の一問","思い込み"],"summary":"移動中に道の途中で止まり子どもが生まれても慌てず、病院にも寄らず車に乗せて移動を続ける男の理由を問う水平思考。人生ゲームの車の駒だった。盤上の一場面を切り取る定番を日本で通じる形に置き換えた。","illustration_scene":"夜の街灯に照らされた曲がりくねった一本道を、小さな車が1台走っていく。道の先に大きな「?」。車の窓の中・赤ちゃん・盤・ルーレット・人物・文字・数字は描かない。"}',
        '類型: 水平思考の定番(現実の出来事に見せて実はボードゲームの盤上の話。原形は車を押してホテルへ・土地売買のボードゲーム。作者不詳・英語圏に流布)。流布例: https://en.wikipedia.org/wiki/Situation_puzzle , https://carxplorer.com/a-man-pushes-his-car-to-a-hotel/ 。日本で通じるよう人生ゲーム版へ置き換え、原形と同じく盤上の一場面だけを切り取った(2026-09-23 レビュー・ユーザー指示)。文面はオリジナルに書き下ろし(表現は書き直し済み)。', 1);
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'logic-training-1'),
        ...
        '3段のまま(船ごと浮き上がる)',
        '{"hook":"夜の港の静かな一問","hint":"海面だけが動くのか?","question":"港の船の横に縄ばしごが垂れ、下の3段が海に浸かっている。潮が満ちて、海面は1時間に1段分ずつ上がる。3時間後、浸かっているのは何段?","answer":"3段のまま(船ごと浮き上がる)","explanation":"縄ばしごは船にぶら下がっている。潮が満ちれば船も同じだけ浮き上がるので、海面とはしごの位置関係は変わらない。3+3=6段と足すのがひっかけだ。","coach_comment":"足し算の前に全体を見たな!","tags":["ひっかけ","夜の一問","思い込み"],"summary":"船の縄ばしごの下3段が浸かり、潮が1時間に1段ずつ満ちると3時間後は何段浸かるかという定番のひっかけ。船ごと浮くので3段のまま。6段と足させる。","illustration_scene":"夜の港、月明かりと街灯に照らされた海に、木造の船が1隻浮かぶ。船の横腹から縄ばしごが垂れ、下のほうが海に浸かっている。船の上に大きな「?」。人物・文字・数字は描かない。"}',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'logic-training-1'),
        ...
        '運転手は歩いていた(運転していない)',
        '{"hook":"おまわりさん、見逃すの?","hint":"トラックはどこにあった?","question":"トラックの運転手が、一方通行の道を逆向きに進んでいた。すぐそばの警察官は、注意もせずに見送った。なぜ?","answer":"運転手は歩いていた(運転していない)","explanation":"問題文は運転手が「進んでいた」と言うだけで、トラックに乗っていたとは言っていない。歩いて逆向きに進むのは違反ではない。肩書きで乗り物を思い浮かべさせる罠だ。","coach_comment":"言葉をよく読んだ者の勝ちだ!","tags":["水平思考","夜の一問","言葉の罠"],"summary":"一方通行を逆向きに進むトラック運転手を警察官が見送った理由を問う定番。運転手は歩いていた。「運転手=運転中」の思い込みを突く。","illustration_scene":"夜の街灯に照らされた、広めの一車線の一方通行の道路を少し上から見下ろす。中央線は描かない。道ばたに白い矢印が横向き(左向き)の長方形の青い一方通行標識が立つ。道の少し先の歩道に、こちらを向いて立つ警察官が中くらいの大きさで見える(この問題は顔を描いてよい)。道路の上に大きな「?」。トラック・車・歩く人・文字は描かない。"}',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'logic-training-1'),
        ...
        '右(乗り口は左側。見えているのは右側面)',
        '{"hook":"絵をよく見て決めてくれ","hint":"絵に描かれていないものは何だ?","question":"日本の路線バスの絵だ。このバスは、右と左のどちらへ走っている?","answer":"右(乗り口は左側。見えているのは右側面)","explanation":"日本は左側通行なので、路線バスの乗り降りのドアは車体の左側にある。絵のバスにはドアが見えないので右側面を見ていることになり、進む向きは右だ。","coach_comment":"見えないドアに気づいたか!","tags":["水平思考","夜の一問","観察力"],"summary":"前後の分からない路線バスの絵で進行方向を問う定番。日本はドアが左側なので、ドアの見えない面は右側面で、進行方向は右。見えないものから推理する。","illustration_scene":"夜の街灯の下、真横から見た路線バス。見えている側面には同じ形の窓が並ぶだけで、ドアは1つもない。車体の前後は同じ形にし、運転席・ライト・ミラー・行き先表示は描かない。地面は模様のない一色の平らな面にし、車線・白線・歩道・縁石・ガードレールは描かない。バスの上に大きな「?」。人物・文字・数字は描かない。"}',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'logic-training-1'),
        ...
        '隣の客のいびきを電話で止めた',
        '{"hook":"電話1本でぐっすり?","hint":"眠れなかった原因はどこにある?","question":"ホテルで眠れない男が、隣の部屋に電話をかけた。何も話さずに切ると、すぐにぐっすり眠れた。なぜ?","answer":"隣の客のいびきを電話で止めた","explanation":"眠れなかったのは、隣の客のいびきがうるさかったから。電話のベルで目を覚まさせれば、いびきが止まる。その間に自分が先に寝てしまえばいい。","coach_comment":"音の出どころを見抜いたな!","tags":["水平思考","夜の一問","状況推理"],"summary":"眠れない男が隣室に電話して無言で切るとすぐ眠れた理由を問う水平思考の定番。隣の客のいびきを電話で起こして止めた。いびきは問題文に出てこない。","illustration_scene":"夜のホテルの客室。スタンドの明かりの下、ベッドに腰かけた男の後ろ姿が受話器を耳に当てている。隣の部屋との壁の上に大きな「?」。隣の部屋の中・寝ている人・人物の顔・文字・数字は描かない。"}',
