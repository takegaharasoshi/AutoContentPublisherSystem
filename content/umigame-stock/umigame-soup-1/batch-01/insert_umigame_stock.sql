...
Scene: A quiet restaurant in the evening; a middle-aged man sits alone at a table with a bowl of soup and a spoon, covering his eyes with one hand as tears fall; a chef in a white uniform stands beside the table looking concerned; warm lamp light, a few empty tables behind, no readable writing, no text. Wide shot from across the room: the man''s table and the chef are small figures in the lower-middle of the picture, the chef''s head well below the middle of the image height.

Vertical 9:16 composition (1024x1536). No text, no letters, no numbers, no logos, no signs. Depict only the scene described in the problem statement; do not depict any clue to the story''s hidden truth. People: only the persons who appear in the problem, plus at most one distant silhouette. Wide establishing shot: show every person small and full-body in the middle distance (each figure at most one fifth of the image height), never a close-up, portrait or half-body shot; convey feelings through posture, not faces. Place all people in the lower-center: horizontally within the middle 20% of the width (group several people closely, side by side or one behind another), vertically between 55% and 85% of the image height. The upper half of the image must contain no people at all: keep it calm and simple (sky, wall, ceiling, window) because text cards are overlaid there. The left 40% and right 40% of the lower half: scenery and props only, no people, because two mascot characters are overlaid there.',
        '【探偵カメロックのウミガメのスープ】
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '[{"role":"questioner","text":"男は悪口を言われるのが好きな人？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"相手は男の友だち？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"2人は前にも会った？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A middle-aged man in a plain shirt seen from behind, walking alone along a quiet residential street in late afternoon; his long shadow stretches ahead of him on the pavement; low houses, a utility pole and a hedge along the street; soft warm sunlight, no other people. The man is a small figure in the middle distance, about one seventh of the image height, at the horizontal center of the picture.
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '["ピアニストは一音も間違えていない。楽譜どおりの正しい演奏だった","男は音楽に詳しくなく、ピアノも弾けない","男の耳や記憶力に問題があるわけではない","男はその曲をよく知っていて、鼻歌で歌えるほどだった","男がその曲を覚えたのは、CD・テレビ・ラジオ・動画からではない","男はその曲を、演奏会の前から毎日のように聞いていた","男が聞き慣れていた曲は、ある1か所がいつも同じように違っていた（なぜ違うのかは答えの核心。正解宣言のとき以外は補足で言わない）","別の編曲・別の版の楽譜の話ではない","隣の女は男の妻で、男がなぜそう言ったのかをすぐに分かった","女は男をばかにしたのではない。おかしくて、ほほえましくて笑った","ピアニストの名前・曲名・会場の場所は問題に関係ない"]',
        ...
        '男だけ間違いと思った真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        ...
        '[{"role":"questioner","text":"ピアニストが間違えた？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"男はその曲を知ってた？"},{"role":"master","text":"はい！"},{"role":"questioner","text":"男は音楽の専門家？"},{"role":"master","text":"いいえ。"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.
...
Scene: Five young men in plain clothes standing in a row on a short flight of wide steps, holding small drums and a flute but not playing, perfectly still; two or three people watching from below with delighted faces; warm soft light, simple background, no text or letters anywhere. The watching people stand together at the foot of the steps in the horizontal center of the picture, not at the left or right edges.
...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '009-year-late-verdict', '1年越しの判定', 4,
        '夏、男は弟と実家へ帰った。庭のいちばん奥のすみに、小さなすいかが1つ実っていた。男はそれをしばらく黙って眺めてから、笑って弟に「お前の勝ちだ」と言った。どういうこと？',
        '去年の夏、30 代の兄弟は実家の縁側ですいかを食べながら、子どものころのように種飛ばしで勝負した。兄の種は縁側のすぐ先に落ちるのを2人とも見ていた。弟は「庭のいちばん奥の塀ぎわまで飛んだ」と言い張ったが、種は草の中に消えて見つからず、兄は「そこまで飛ぶわけがない」と自分の勝ちを譲らなかった。今年の夏に帰省すると、庭のいちばん奥のすみに、誰も植えていないすいかが実っていた。母はすいかを植えておらず、あの縁側で種を飛ばしたのは去年のあの日だけだった。弟の種は本当に塀ぎわまで飛んでいて、そこで芽を出して育ったのだ。1年越しに証拠が出てきたので、男は笑って負けを認めた。',
        '["すいかは男の母も家族も植えていない。すいかを育てる勝負をしていたのでもない","すいかは誰かが持ってきて置いたものではなく、その場所で自然に育った","男と弟は 30 代の大人で、子どもではない","男と弟は、ちょうど1年前の夏に、この実家である勝負をしていた","その勝負はお金や物を賭けたものではない","勝負のとき、決め手になるものが見つからず、2人とも自分の勝ちを言い張った（何が見つからなかったかは答えの核心。正解宣言のとき以外は補足で言わない）","すいかが実っていた場所が、勝負の結果と関係している","男は負けを認めたが、悔しいというより愉快だった","すいかの大きさ・味・品種は問題に関係ない","母や兄弟の仕事・住まいは問題に関係ない"]',
        '[{"q":"すいかは誰かが植えたものですか？","a":"いいえ"},{"q":"すいかを育てる勝負をしていましたか？","a":"いいえ"},{"q":"すいかの大きさを比べる勝負ですか？","a":"いいえ"},{"q":"お金を賭けていましたか？","a":"いいえ"},{"q":"2人は以前に何かの勝負をしましたか？","a":"はい"},{"q":"その勝負は実家でしましたか？","a":"はい"},{"q":"その勝負は去年のことですか？","a":"はい"},{"q":"その勝負は、その場で決着がつきましたか？","a":"いいえ"},{"q":"すいかが実っていた場所は関係ありますか？","a":"はい"},{"q":"すいかは種から自然に育ちましたか？","a":"はい"},{"q":"勝負はすいかを食べたときにしましたか？","a":"はい"},{"q":"勝負に、すいかの種が関係していますか？","a":"はい"},{"q":"2人は子どもですか？","a":"いいえ"},{"q":"男は悔しがっていますか？","a":"いいえ"},{"q":"すいかの味は関係ありますか？","a":"関係ない"},{"q":"母の仕事は関係ありますか？","a":"関係ない"},{"q":"去年の夏、2人は実家ですいかの種飛ばしをして、弟は庭の奥まで飛んだと言い張ったが種が見つからなかった。その種が育ってすいかが実ったので、弟の勝ちだと分かった。","a":"正解"}]',
        '弟の勝利の真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        ...
        '[{"role":"questioner","text":"すいかは誰かが植えた？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"何か勝負をしていた？"},{"role":"master","text":"はい！"},{"role":"questioner","text":"大きさ比べの勝負？"},{"role":"master","text":"いいえ。"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A wide view of a sunny summer afternoon in the garden of a Japanese family house with a wooden veranda; two adult brothers in their thirties stand far away at the far corner of the garden by the fence, looking down at a single watermelon growing on a vine in the grass at their feet; one man grins and pats his brother on the shoulder, the other smiles proudly. The watermelon is clearly visible: a bright green striped ball, drawn slightly larger than life so it stands out against the grass. No seeds, no people eating, no text.
...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '010-two-hour-dentist', '2時間かけて通う歯医者', 4,
        '虫歯も痛いところもない男が、電車で2時間かけて、ある町の小さな歯医者に半年ごとに通っている。診察が終わっても、男はしばらく待合室の同じ席に座ってから帰る。どういうこと？',
        '男は小学生のころまで、その町の古い木造の家で育った。父の転勤で一家は引っ越し、家は人手に渡った。家を買った人は、1 階を改装して小さな歯医者を開いた。40年後、男はそのことを知り、中に入る方法として、半年ごとの歯の検診をその歯医者で受けることにした。今の家からは電車で2時間かかるが、男には虫歯も痛みもない。待合室の柱には、子どものころに父が刻んだ男の背丈の傷がそのまま残っている。男は診察のあと、その柱の前の席にしばらく座ってから帰る。男が通っているのは、歯医者になった自分の生家だった。',
        '["男には虫歯も痛いところもなく、特別な治療も受けていない。受けているのは半年ごとのふつうの検診","歯医者の先生・受付の人・ほかの患者は、男の知り合いでも家族でもない","その歯医者の腕や料金・設備が特別に良いわけではない","男は子どものころ、その町に住んでいた。今は電車で2時間かかる別の町に住んでいる","歯医者は古い建物を改装して開かれた小さな医院で、40年ほど前にはまだ歯医者ではなかった","男が通う理由は、歯医者の建物そのものにある（どういう建物かは答えの核心。正解宣言のとき以外は補足で言わない）","待合室の男がいつも座る席の近くに、男にとって大切なものが残っている（それが何かは答えの核心。正解宣言のとき以外は補足で言わない）","先生は男が通う理由を知らない。男は誰にも迷惑をかけていない","男は悲しんでいるのではなく、懐かしんでいる","男の仕事・家族構成・年齢は問題に関係ない","電車の路線・歯医者の名前は問題に関係ない"]',
        ...
        '2時間かけて通う真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '男は10年ほど、毎朝7時40分ちょうどに家を出て、小学校の通学路をジョギングしていた。通学路の家の子どもたちは、窓の外を男が走って通るのを見ると「そろそろ出なきゃ」と家を出るようになっていたが、男はそのことを知らなかった。ある朝、男は用事があって、いつもより20分早く走り出た。男の姿を見た子どもたちは、遅刻すると思い込んで朝ごはんを口にくわえたまま次々に家を飛び出し、男を追い抜いて学校へ駆けていった。実際の時刻はまだ早く、子どもたちは校門が開くより先に門の前に並ぶことになった。',
        '["子どもたちは男を怖がっていない。男は不審者でも、学校の先生でもない","その朝、学校に特別な行事はなかった。鬼ごっこや競走などの遊びでもない","男は子どもたちに何も言っていないし、合図を送ったつもりもない","男は10年ほど、毎朝同じ道を同じように走っている","子どもたちは、家の窓から男の姿を見て、急がなければと思った（なぜそう思ったかは答えの核心。正解宣言のとき以外は補足で言わない）","子どもたちは実際には遅刻しそうではなかった。学校に着いたとき、校門はまだ開いていなかった","家の時計は壊れていない。時計を見ていれば、まだ早いと分かった","男は、子どもたちが走っていった理由をその朝まで知らなかった","男がいつもより早く走ったのは用事があったから。用事の中身は問題に関係ない","子どもたちは男の家族でも知り合いでもない。名前も知らない","男の年齢・服装・走る速さは問題に関係ない"]',
        ...
        '子どもたちの行動の真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '013-fifty-five-year-nengajo', '55年目の年賀状', 4,
        '70歳の男は元日、ある友人から届いた年賀状を読むと、家族の前で「勝った！」と万歳した。2人は中学を卒業してから、55年間、一度も会っていない。どういうこと？',
        '男は中学3年の春、放課後に友人と指していた将棋を終えないまま、友人の転校で離ればなれになった。2人は「続きは年賀状で」と約束し、それから毎年の年賀状に将棋の1手ずつを書いて送り合った。男は元日に届いた相手の1手を1年かけて考え、年末に次の1手を書いて出した。盤は駒を並べたまま、男の家の床の間に55年間置かれていた。70歳の元日、友人の年賀状には次の1手の代わりに「参りました」と書かれていた。男は55年かけた1局に勝ち、家族の前で万歳した。2人は卒業以来、一度も会っていない。',
        '["年賀状は友人本人が書いたもの。友人は元気に暮らしている","男はくじに当たったのではない。お金や品物は何ももらっていない","2人は何も賭けていない。お金や物のやりとりはない","長生きや、子ども・孫の数、年賀状の枚数を比べていたのではない","2人は中学の同級生。中学3年の春に友人が転校し、別の町へ引っ越した","2人は卒業してから電話もしていない。毎年の年賀状だけをやりとりしている","年賀状には、新年のあいさつのほかに短い言葉が書かれていた（何が書かれていたかは答えの核心。正解宣言のとき以外は補足で言わない）","2人がしていたのは体を動かす勝負ではなく、頭を使う勝負","勝負は中学のころに始まり、55年かけてこの元日に決着した","勝負そのものは、本来なら数時間で終わる種類のもの","男は毎年、この友人への年賀状を書くのに長い時間をかけていた","家族は、男がこの友人と勝負を続けていることを知っていた","男の仕事、友人の住む町、年賀状の絵柄は問題に関係ない"]',
        '[{"q":"くじに当たったのですか？","a":"いいえ"},{"q":"何かを賭けていたのですか？","a":"いいえ"},{"q":"友人は亡くなったのですか？","a":"いいえ"},{"q":"長生きを競っていたのですか？","a":"いいえ"},{"q":"2人は何かの勝負をしていたのですか？","a":"はい"},{"q":"体を動かす勝負ですか？","a":"いいえ"},{"q":"年賀状に書かれていた言葉が関係ありますか？","a":"はい"},{"q":"友人が負けを認めたのですか？","a":"はい"},{"q":"盤を使うゲームですか？","a":"はい"},{"q":"年賀状で勝負を進めていたのですか？","a":"はい"},{"q":"勝負は中学のころに始まりましたか？","a":"はい"},{"q":"2人は電話で話していましたか？","a":"いいえ"},{"q":"家族は勝負のことを知っていましたか？","a":"はい"},{"q":"男の仕事は関係ありますか？","a":"関係ない"},{"q":"年賀状の絵柄は関係ありますか？","a":"関係ない"},{"q":"2人は中学のときに終わらなかった将棋の続きを、毎年の年賀状に1手ずつ書いて指していて、この元日の年賀状で友人が負けを認めた。","a":"正解"}]',
        '55年後の勝利の真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"七十歳の男は元日、ある友人から届いた年賀状を読むと、家族の前で、勝ったと言って万歳した。二人は中学を卒業してから、五十五年間、一度も会っていない。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"くじに当たった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"友人と勝負してた？"},{"role":"master","text":"はい！"},{"role":"questioner","text":"55年も必要な勝負？"},{"role":"master","text":"いいえ。"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A Japanese tatami living room on New Year''s morning; an elderly man in his seventies raises both arms in joy while holding a single New Year''s postcard, his wife and grown-up family around a low table with New Year''s dishes look at him with amused smiles; a pile of other postcards on the table, no readable writing, no text. The whole family group is placed low in the picture: even the old man''s raised hands stay below about 62% of the image height. The room is a small, cozy tatami room sized to the people (low ceiling, close walls, normal-sized sliding doors), so the family does not look tiny in a huge hall.
...
Scene: A man and a woman in summer clothes standing face to face in a bright Japanese room, firmly holding each other''s hands as if making a promise, both smiling gently; warm evening light after summer rain outside the window; no paper, no letter, no notebook, no pen, no hair dryer, nobody sad.
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '外国から嫁いできた女と義母は、同居してから10年間、近所で評判の仲のよさだった。ところが女が日本語を覚えて話せるようになると、2人は毎日けんかを始めた。どういうこと？',
        '女は外国で日本人の夫と結婚し、息子が5歳のとき一家で日本へ移って、夫の母と同居を始めた。女は日本語がほとんど話せず、夫は仕事で帰りが遅かったので、義母との会話は2つの言葉を話す息子が通訳した。息子は2人のけんかを見たくなくて、義母が「味が薄い」と言えば母に「やさしい味だって」と伝え、母が「口を出さないで」と言えば義母に「教えてくれてありがとうだって」と伝えた。2人は10年間、近所で評判の仲のよい嫁と姑だった。息子が高校の寮に入った春、女は辞書を片手に日本語を覚え、義母と通訳なしで話すようになった。すると初めて本当の言葉が聞こえ、2人は毎日言い合いを始めた。やがて10年分の通訳がほとんど作り話だったと気づき、2人そろって息子に電話をかけた。',
        '["義母の性格や考え方は、この10年で変わっていない。義母は前から同じようなことを言っていた","誰かが悪口を吹き込んだのではない。近所の人は何もしていない","女が日本語を覚える前も、2人は毎日たくさん会話をしていた","2人の会話には、いつも間に入って伝える家族がいた（誰がどう伝えていたかは答えの核心。正解宣言のとき以外は補足で言わない）","間に入っていたのは夫ではない。夫は仕事で帰りが遅く、平日はほとんど家にいなかった","同居は10年前、一家が女の国から日本へ移ってきたときに始まった","女が日本語を覚えたのはこの春から。辞書を使って自分で勉強した","けんかの中身は、料理の味つけや家事のやり方など、前から毎日話題にしていたこと","2人は本当は嫌い合ってはいない。今もけんかをしながら同じ家で暮らしている","2人はけんかの理由に気づき、今では笑い話にしている","女の出身の国、義母の年齢、家のある町は問題に関係ない"]',
        '[{"q":"義母の性格が変わったのですか？","a":"いいえ"},{"q":"誰かが悪口を吹き込んだのですか？","a":"いいえ"},{"q":"近所の人が何かしたのですか？","a":"いいえ"},{"q":"日本語が分かるようになって、義母の文句に気づいたのですか？","a":"はい"},{"q":"義母は前から同じようなことを言っていたのですか？","a":"はい"},{"q":"前は2人の言葉が通じていなかったのですか？","a":"はい"},{"q":"2人の間に入って伝える人がいたのですか？","a":"はい"},{"q":"間に入っていたのは家族ですか？","a":"はい"},{"q":"間に入っていたのは夫ですか？","a":"いいえ"},{"q":"伝える人は、言葉をそのまま伝えていましたか？","a":"いいえ"},{"q":"女の言葉も変えて伝えられていましたか？","a":"はい"},{"q":"女が日本語を覚えたのは最近ですか？","a":"はい"},{"q":"2人は本当は嫌い合っているのですか？","a":"いいえ"},{"q":"女の出身の国がどこかは関係ありますか？","a":"関係ない"},{"q":"義母の年齢は関係ありますか？","a":"関係ない"},{"q":"2人の会話は家族が通訳していて、お互いの文句を褒め言葉に言い換えて伝えていたので、女が日本語を覚えて本当の言葉が分かるとけんかになった。","a":"正解"}]',
        '嫁姑、突然の不仲の真相は？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        ...
        '[{"role":"questioner","text":"義母の性格が変わった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"女と義母は10年話してなかった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"2人以外の誰かが関係している？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A Japanese home kitchen; a clearly Western (European-looking) woman in her forties with blonde hair and fair skin, and her elderly Japanese mother-in-law stand side by side at the stove, both frowning and arguing with animated hand gestures over a pot of miso soup; an open bilingual dictionary lies on the kitchen table; warm afternoon light, no readable writing, no text. The two women are placed low in the picture: their heads stay below about 62% of the image height.
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '男は運転免許を一度も取ったことがない。それでも休みの日になると、妻と子どもたちを車に乗せて、長い道のりを走る。家族はみんな楽しそうで、誰も止めようとしない。どういうこと？',
        '男が走らせているのは本物の自動車ではなく、人生ゲーム（すごろく型のボードゲーム）の車の駒。休みの日になると男は家族とテーブルを囲んで人生ゲームで遊ぶ。ゲームの中で男は結婚し、子どもが生まれ、そのたびに妻や子どもを表すピンを車の駒の穴に差して乗せ、ルーレットを回して盤の上の長い道を進む。おもちゃなので免許はいらず、一緒に遊ぶ家族もみんな楽しんでいるので、止める人は誰もいない。',
        '["男は運転免許を一度も取ったことがない（取り消されたのでも、取り上げられたのでもない）","男は決まりや法律を破っていない。警察に注意されることもない","車を動かしているのは男自身。自動運転の車ではなく、妻や他の人が代わりに運転しているのでもない","男の車は本物の自動車ではない。男は車の中に座ってハンドルを握る「運転」はしておらず、車の外から動かしている","車が何で、車に乗っている妻と子どもたちが何なのかは、この問題の答えの核心である（正解宣言のとき以外は補足で言わない）","車に乗っている妻と子どもたちは、本物の人間ではない。誰もけがをせず、危ないこともない","車が走るのは家の中。私有地・サーキット・遊園地・ゲームセンターではない","テレビやスマホの画面、コントローラーは使わない。ラジコンでもない","休みの日に本物の家族みんなで集まり、順番に楽しんでいる。家族が楽しそうなのはそのためである","車が一度にどこまで進むかは、男が決めるのではなく毎回変わる","車が走る道の途中では、仕事・結婚・家を買うといった人生の出来事が起きる","「ボードゲーム」「おもちゃ」と言い当てただけでは正解にしない。車と、車に乗っている妻と子どもたちの正体まで言えたら正解","男の年齢・職業・車の色・家族の人数は問題に関係ない"]',
        '[{"q":"男は法律を破っていますか？","a":"いいえ"},{"q":"男は免許を取り消されたのですか？","a":"いいえ"},{"q":"私有地で運転しているのですか？","a":"いいえ"},{"q":"自動運転の車ですか？","a":"いいえ"},{"q":"妻が代わりに運転しているのですか？","a":"いいえ"},{"q":"遊園地のゴーカートですか？","a":"いいえ"},{"q":"車は本物の自動車ですか？","a":"いいえ"},{"q":"男は車の中に座っていますか？","a":"いいえ"},{"q":"男が運転しているわけではないのですか？","a":"はい"},{"q":"テレビゲームですか？","a":"いいえ"},{"q":"家の中での話ですか？","a":"はい"},{"q":"家族と一緒に遊んでいるのですか？","a":"はい"},{"q":"車がどこまで進むかは毎回変わりますか？","a":"はい"},{"q":"テーブルの上での話ですか？","a":"はい"},{"q":"車に乗っている妻と子どもたちは本物の人間ですか？","a":"いいえ"},{"q":"車の色は関係ありますか？","a":"関係ない"},{"q":"男の年齢は関係ありますか？","a":"関係ない"},{"q":"男は休みの日に家族と人生ゲームで遊んでいて、車はゲームの車の駒、妻と子どもたちは駒に差したピンだった。","a":"正解"}]',
        '無免許男の大暴走？', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"男は運転免許を一度も取ったことがない。それでも休みの日になると、妻と子どもたちを車に乗せて、長い道のりを走る。家族はみんな楽しそうで、誰も止めようとしない。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"男は法律を破ってる？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"私有地で走ってる？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"男が運転しているわけではない？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A small family car driving along a long winding road through green hills and fields on a sunny holiday morning, seen from far away so that no one inside is visible; a few houses and trees along the road; bright clear sky, no other vehicles, no people outside, no text. The road curves into the lower center of the picture, and the car is on it exactly at the horizontal center, about 70% down from the top of the image, small but clearly visible; the left and right sides of the lower half show only fields and trees.
