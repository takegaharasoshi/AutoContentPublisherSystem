...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '001-faint-shadow', '影が薄いと言われて喜ぶ男', 3,
        '半年前、男は「影が濃くなりましたね」と言われてひどく落ち込んでしまった。今日、同じ相手に「影がだいぶ薄くなりましたね」と言われて、男は泣いて喜んだ。どういうこと？',
        '「影」は男の存在感のことではなく、レントゲン写真に白く写る病気の跡のこと。半年前、男は健康診断のレントゲンで肺に影が見つかり、医者に「影が濃くなっている」と告げられて治療を始めた。今日の検査で同じ医者に「影がだいぶ薄くなった」と言われた。病気が良くなっている証拠なので、男はうれしくて泣いた。',
        '["「影」はレントゲン写真に写った病気の跡（白く写る部分）のことである","太陽や照明でできる足元の影・男の存在感や性格のことではない","二回とも言ったのは同じ病院の同じ医者で、男の主治医である","半年前、男は健康診断のレントゲンで肺に影が見つかり、悪くなっていると分かって落ち込んだ","男はその後、半年間通院して治療を続けた（入院はしていない）","今日の検査で影が薄くなっていた。これは病気が良くなっている証拠である","今日の涙はうれし涙である","医者は男をからかったり、意地悪で言ったりしていない","男は 40 代の会社員だが、年齢・職業・家族の有無は問題に関係ない","病気の名前・治療の内容は問題に関係ない","男の人付き合いや目立つかどうかは問題に関係ない"]',
        '[{"q":"影は男の足元にできる影のことですか？","a":"いいえ"},{"q":"影は太陽や電気の光でできる影ですか？","a":"いいえ"},{"q":"影というのは男の存在感のことですか？","a":"いいえ"},{"q":"言ったのは男の友だちですか？","a":"いいえ"},{"q":"言ったのは男の家族ですか？","a":"いいえ"},{"q":"言ったのは医者ですか？","a":"はい"},{"q":"影は写真に写っていますか？","a":"はい"},{"q":"その写真は病院で撮ったものですか？","a":"はい"},{"q":"影は男の体の中にありますか？","a":"はい"},{"q":"影は病気と関係がありますか？","a":"はい"},{"q":"影が濃いほうが良いことですか？","a":"いいえ"},{"q":"男はこの半年の間に治療を受けましたか？","a":"はい"},{"q":"男は入院していましたか？","a":"いいえ"},{"q":"男が泣いたのは悲しかったからですか？","a":"いいえ"},{"q":"男の病気は良くなってきていますか？","a":"はい"},{"q":"男の年齢は重要ですか？","a":"関係ない"},{"q":"病気の名前は重要ですか？","a":"関係ない"},{"q":"男に家族がいるかどうかは重要ですか？","a":"関係ない"},{"q":"影はレントゲン写真に写った病気の跡で、薄くなったのは病気が良くなった証拠だから男は泣いて喜んだ。","a":"正解"}]',
        '影が薄いと言われて大喜び', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"半年前、男は、影が濃くなりましたね、と言われてひどく落ち込んでしまった。今日、同じ相手に、影がだいぶ薄くなりましたね、と言われて、男は泣いて喜んだ。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"影は本物の影？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"男の性格の話？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"何かの写真の話？"},{"role":"master","text":"はい！"}]',
...
Vertical 9:16 composition (1024x1536). No text, no letters, no numbers, no logos, no signs. Depict only the scene described in the problem statement; do not depict any clue to the story''s hidden truth. People: only the persons who appear in the problem, plus at most one distant silhouette. Keep the upper 55% of the image calm and simple (sky, wall, ceiling, window) so that text cards can be overlaid there.',
        '【探偵カメロックのウミガメのスープ】
「影が薄くなった」と言われて泣いて喜んだ男。半年前は「濃くなった」と言われて落ち込んでいたのに。
