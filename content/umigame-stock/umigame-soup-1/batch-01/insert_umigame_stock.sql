...
Scene: A small family car driving along a long winding road through green hills and fields on a sunny holiday morning, seen from far away so that no one inside is visible; a few houses and trees along the road; bright clear sky, no other vehicles, no people outside, no text.
