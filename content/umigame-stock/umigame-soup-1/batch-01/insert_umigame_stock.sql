...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '「卵」とは、パン職人の卵、つまり見習いの若者のこと。主人は十年前に店へ来た見習いを、自分の店の「卵」と呼んでかわいがり、パン作りを教えて一人前に育て上げた。いまでは店でいちばんおいしいパンをその卵が焼いているので、「パンがおいしいのはこの卵のおかげ」という自慢は本当のこと。食べ物の卵ではないので、ゆでることも割ることもしない。',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '["約束は取り消されていない。二人の気持ちも変わっていない","二人はけんかをしておらず、仲は良いまま","白紙に戻ったのは、目に見える形のあるもの","約束は口約束ではなく、書かれたものだった","書かれたものは破れても燃えてもおらず、今も手元にある","起きたことは事故のようなもので、誰のいたずらでもない","夏の天気（夕立）が関係している","濡れたものを乾かしたことが関係している","文字を書いた道具に特徴がある（種類は答えの核心。正解宣言のとき以外は補足で言わない）","約束の中身は二人とも覚えていた","二人の関係・職業・年齢・約束の中身は問題に関係ない"]',
        ...
        '[{"role":"questioner","text":"二人はけんかした？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"季節は関係ある？"},{"role":"master","text":"はい！"},{"role":"questioner","text":"二人は恋人？"},{"role":"master","text":"関係ありません。"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '70歳の男は元日、ある友人から届いた年賀状を読むと、家族の前で「勝った！」と万歳した。二人は中学を卒業してから、55年間、一度も会っていない。どういうこと？',
        '男は中学3年の春、放課後に友人と指していた将棋を終えないまま、友人の転校で離ればなれになった。二人は「続きは年賀状で」と約束し、それから毎年の年賀状に将棋の一手ずつを書いて送り合った。男は元日に届いた相手の一手を一年かけて考え、年末に次の一手を書いて出した。盤は駒を並べたまま、男の家の床の間に55年間置かれていた。70歳の元日、友人の年賀状には次の一手の代わりに「参りました」と書かれていた。男は55年かけた一局に勝ち、家族の前で万歳した。二人は卒業以来、一度も会っていない。',
        '["年賀状は友人本人が書いたもの。友人は元気に暮らしている","男はくじに当たったのではない。お金や品物は何ももらっていない","二人は何も賭けていない。お金や物のやりとりはない","長生きや、子ども・孫の数、年賀状の枚数を比べていたのではない","二人は中学の同級生。中学3年の春に友人が転校し、別の町へ引っ越した","二人は卒業してから電話もしていない。毎年の年賀状だけをやりとりしている","年賀状には、新年のあいさつのほかに短い言葉が書かれていた（何が書かれていたかは答えの核心。正解宣言のとき以外は補足で言わない）","二人がしていたのは体を動かす勝負ではなく、頭を使う勝負","勝負は中学のころに始まり、55年かけてこの元日に決着した","勝負そのものは、本来なら数時間で終わる種類のもの","男は毎年、この友人への年賀状を書くのに長い時間をかけていた","家族は、男がこの友人と勝負を続けていることを知っていた","男の仕事、友人の住む町、年賀状の絵柄は問題に関係ない"]',
...
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        ...
        '[{"role":"questioner","text":"義母の性格が変わった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"女と義母は十年間話してなかった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"二人以外の誰かが関係している？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.
