...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '012-silent-musicians', '階段に並ぶ、音を出さない男たち', 2,
...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '013-fifty-year-letter', '会ったことのない男の子からの手紙', 4,
...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '014-bakers-egg', '店でいちばんのパンを焼く卵', 4,
        'パン屋の主人は、店の卵を十年間、大切に育ててきた。焼いたことも、割ったことも一度もない。いまでは、店でいちばんおいしいパンは、その卵が焼いている。どういうこと？',
        '「卵」とは、パン職人の卵、つまり見習いの若者のこと。主人は十年前に店へ来た見習いを、自分の店の「卵」と呼んでかわいがり、パン作りを教えて一人前に育て上げた。いまではその卵が店でいちばんおいしいパンを焼く職人になっている。食べ物の卵ではないので、焼いたことも割ったこともないのは当たり前で、十年たっても腐らない。',
        '["「卵」が何（誰）なのかは、この問題の答えの核心である（正解宣言のとき以外は補足で言わない）","卵はひよこや鶏になったのではない。温めてかえしたのでもない","魔法・おとぎ話・作り話ではない。現実にどこの町でも起こることである","主人は卵を食べたり売ったりするつもりで育てたのではない","卵は冷蔵庫にも巣にも入っていない","卵は十年たっても腐っていない","卵は道具や機械の力を借りずに、自分でパンを焼ける","主人がパンを焼けなくなったから卵が焼いているのではない（主人は元気である）","「育てた」は、えさや水をやったという意味ではない。教えて育てたという意味である","卵は毎日、主人といっしょに店で働いている","店の場所・パンの種類は問題に関係ない"]',
        '[{"q":"卵はひよこにかえったのですか？","a":"いいえ"},{"q":"卵は鶏になってパンを焼いているのですか？","a":"いいえ"},{"q":"これは魔法やおとぎ話の出来事ですか？","a":"いいえ"},{"q":"卵は腐ってしまいましたか？","a":"いいえ"},{"q":"主人は卵を食べるために育てたのですか？","a":"いいえ"},{"q":"卵は冷蔵庫に入っていますか？","a":"いいえ"},{"q":"「卵」は食べ物の卵ですか？","a":"いいえ"},{"q":"卵は生き物ですか？","a":"はい"},{"q":"卵は人ですか？","a":"はい"},{"q":"卵はパンを作る仕事をしていますか？","a":"はい"},{"q":"卵は主人の家族ですか？","a":"いいえ"},{"q":"主人は卵にパンの作り方を教えましたか？","a":"はい"},{"q":"主人は病気でパンを焼けないのですか？","a":"いいえ"},{"q":"パンの種類は答えに関係ありますか？","a":"関係ない"},{"q":"店の場所は答えに関係ありますか？","a":"関係ない"},{"q":"卵は毎日店で働いていますか？","a":"はい"},{"q":"「卵」とはパン職人の卵、つまり見習いの人のこと。主人は見習いを十年かけて一人前に育て、いまはその人が店でいちばんおいしいパンを焼いている。","a":"正解"}]',
        '店一番のパンは卵が焼く', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"パン屋の主人は、店の卵を十年間、大切に育ててきた。焼いたことも、割ったことも一度もない。いまでは、店でいちばんおいしいパンは、その卵が焼いている。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"卵はひよこになった？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"魔法の話？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"卵は生き物？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.
...
Vertical 9:16 composition (1024x1536). No text, no letters, no numbers, no logos, no signs. Depict only the scene described in the problem statement; do not depict any clue to the story''s hidden truth. People: only the persons who appear in the problem, plus at most one distant silhouette. Keep the upper 55% of the image calm and simple (sky, wall, ceiling, window) so that text cards can be overlaid there.',
        '【探偵カメロックのウミガメのスープ】
店の卵を十年間、大切に育ててきたパン屋の主人。いまでは、店でいちばんおいしいパンは、その卵が焼いています。
...
#ウミガメのスープ #水平思考 #推理クイズ #なぞなぞ #謎解き #クイズ #AIart',
        '完全オリジナル（既存問題の転載・改変ではない）。作問法は note 記事 https://note.com/suekai0217/n/n35128e606a9b の4 ステップ（モチーフ → 連想 → 言い方を変える → 不思議にする）と良い問題の 3 条件（コアが明確・動線がある・現実離れしない）に従う。着想の型は research.md（Codex Web リサーチ台帳）を参照。 型: 意味誤誘導型。モチーフ「たまご」（作問スキル umigame-problem-writer の抽選 3 語〔ベンチ・たまご・階段〕から。前 3 回の抽選〔自転車・すいか・花火 → 初案取り下げ / 帽子・体重計・お守り → 猫をかぶる案が差し戻し / のど飴・鍵・迷子 → 全滅で引き直し〕も記録）→ 連想「医者の卵・役者の卵 = 見習い」→ 抽象化（店の卵を育てる → 職人の卵を育てる）→ 常識「卵は材料で、パンを焼く側ではない」の逆（店でいちばんおいしいパンは、その卵が焼いている）。着想元の既存問題なし（語の多義で場面を反転する構造は台帳 #16〔ホーム = 本塁〕・#23〔撃つ = 撮影〕の型のみ借用。モチーフ・真相・問題文は新規）。捨てた案: タネはありません = 種なしスイカの売り文句〔人間ゲートで「コアが弱い」と取り下げ〕/ 猫をかぶる = かぶりもの〔コア宣言で差し戻し〕/ 白い鍵と黒い鍵 = ピアノ〔英語圏の有名なぞなぞと同構造〕/ 迷子は大人〔決めつけ反転の classic 構造〕/ ベンチを温める〔落差なし・競技用語反転は台帳明示例と同構造〕/ コロンブスの卵・金の卵〔知識クイズ〕。', 1);
