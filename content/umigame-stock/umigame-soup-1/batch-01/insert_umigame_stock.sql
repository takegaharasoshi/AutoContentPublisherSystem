...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '010-rainy-doorbell', '雨が降ると鳴るチャイム', 4,
        '男の家では、雨が降り始めると決まって玄関のチャイムが鳴る。急いで玄関を開けても、客の姿はどこにもない。雨がやんでいる間は、そんなことは一度も起きない。どういうこと？',
        '男の家の犬は、昼間は庭で自由に過ごしている。玄関のチャイムのボタンは門柱の低いところについていて、犬の鼻がちょうど届く高さだった。犬は、家の人がボタンを押すと男が玄関を開けに来るのを何度も見ているうちに、自分で鼻を押しつけてボタンを押すことを覚えた。雨が降り出すと、濡れたくない犬は玄関へ回ってボタンを押す。男が急いで開けると、そこに客はいない。しっぽを振った犬が待っていて、そのまま家へ入ってくる。雨のときにしか鳴らないのは、犬が家に入れてほしくなるのが雨のときだけだったから。チャイムはどこも壊れていない。',
        '["チャイムは、玄関の外のボタンを押すと家の中で鳴る、ごくふつうの電池式のもので、壊れておらず雨で誤作動もしない","チャイムが鳴るたび、ボタンは本当に押されている","ボタンを押しているのは人ではなく、隣の家や通りがかりの人・電波・雨水は関係ない","ボタンは門柱の低い位置にあり、大人は少しかがんで押す","男は生き物を一匹飼っていて、昼間は庭に出している（種類は答えの核心。正解宣言のとき以外は補足で言わない）","その生き物は、庭から玄関のボタンの前まで自由に行き来できる","チャイムが鳴って男が玄関を開けると、飼っている生き物が外で待っていて、家に入ってくる","押すのは偶然ではなく、押せば男が玄関を開けに来ると覚えて、わざと押している","男は押し方を教えていない。見て覚えた","押す理由は、雨に濡れたくなくて家に入れてほしいから","鳴るのは雨が降り出した直後で、雨が降っていないときは押さない","男の仕事・家の場所・家族構成は問題に関係ない"]',
        '[{"q":"チャイムは壊れていますか？","a":"いいえ"},{"q":"雨で機械が誤作動しているのですか？","a":"いいえ"},{"q":"隣の家のチャイムと混線していますか？","a":"いいえ"},{"q":"誰かがボタンを押して逃げていますか？","a":"いいえ"},{"q":"チャイムが鳴るたび、ボタンは本当に押されていますか？","a":"はい"},{"q":"ボタンを押しているのは人ですか？","a":"いいえ"},{"q":"風や落ちてきた物がボタンに当たっていますか？","a":"いいえ"},{"q":"生き物がボタンを押していますか？","a":"はい"},{"q":"その生き物は男の家のものですか？","a":"はい"},{"q":"その生き物は昼間、庭にいますか？","a":"はい"},{"q":"ボタンは低い位置にありますか？","a":"はい"},{"q":"偶然ぶつかっただけですか？","a":"いいえ"},{"q":"押せば男が来ると分かって押していますか？","a":"はい"},{"q":"雨に濡れたくないから押していますか？","a":"はい"},{"q":"男が教えましたか？","a":"いいえ"},{"q":"男の仕事は関係ありますか？","a":"関係ない"},{"q":"家の場所は関係ありますか？","a":"関係ない"},{"q":"男の家の犬が、雨に濡れたくなくて家に入れてもらうために、鼻でチャイムのボタンを押している。","a":"正解"}]',
        '雨が降ると鳴るチャイム', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"男の家では、雨が降り始めると決まって玄関のチャイムが鳴る。急いで玄関を開けても、客の姿はどこにもない。雨がやんでいる間は、そんなことは一度も起きない。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"チャイムが壊れている？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"誰かが押して逃げた？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"何かがボタンを押している？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A man standing in the open front doorway of a Japanese house, looking out with a puzzled face at an empty doorstep as rain begins to fall, a wet garden path and gate beyond, a small doorbell chime unit on the wall inside the entrance; nobody outside; no dog, no animals, no doorbell button shown.

Vertical 9:16 composition (1024x1536). No text, no letters, no numbers, no logos, no signs. Depict only the scene described in the problem statement; do not depict any clue to the story''s hidden truth. People: only the persons who appear in the problem, plus at most one distant silhouette. Keep the upper 55% of the image calm and simple (sky, wall, ceiling, window) so that text cards can be overlaid there.',
        '【探偵カメロックのウミガメのスープ】
男の家では、雨が降り始めると決まって玄関のチャイムが鳴ります。急いで開けても、客の姿はどこにもありません。
...
#ウミガメのスープ #水平思考 #推理クイズ #なぞなぞ #謎解き #クイズ #AIart',
        '完全オリジナル（既存問題の転載・改変ではない）。作問法は note 記事 https://note.com/suekai0217/n/n35128e606a9b の4 ステップ（モチーフ → 連想 → 言い方を変える → 不思議にする）と良い問題の 3 条件（コアが明確・動線がある・現実離れしない）に従う。着想の型は research.md（Codex Web リサーチ台帳）を参照。 型: 物語復元型。モチーフ「チャイム」（作問スキル umigame-problem-writer の抽選。1 回目〔早起き・辞書・影〕の「早起き」から 3 案〔霜柱が苗を持ち上げた = 季節の整合で NG / 植木鉢が凍って中から割れた = 科学的事象だけで驚きなしで NG / 留守宅が冷蔵庫より冷えた = 最初の連想で真相に直行して NG〕、2 回目〔土産・チャイム・なわとび〕の「チャイム」1 案目〔隣家のワイヤレスチャイムの混線 = 技術的原因でひねり不足として NG〕を経て、2 案目で承認）→ 連想「押すのは人とは限らない → 犬が鼻で押す・雨のときだけ」→ 物語 A→B→C（A = 犬は昼間、庭で自由・ボタンは低い位置 / B = 犬がボタンを押せば男が来ると覚え、雨が降ると入れてもらうために鼻で押す / C = 雨が降り始めると決まって鳴り、開けても客はいない）→ B を隠し、読者に「雨で機械が誤作動している」と補わせる。役割の逆転（来客の合図が犬の「入れて」の合図）がコア。着想元の既存問題なし（台帳の story 15 件に「押した者は人ではない」構造はない）。工程 7 の Web 照合の結果は開発記録 21-4a-3 U19 に記載。', 1);
