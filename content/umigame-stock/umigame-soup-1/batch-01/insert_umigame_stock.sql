...
INSERT INTO umigame_stock_items (set_id, content_key, title, difficulty, problem_text, truth, fact_sheet,
    ...
    caption, source_note, is_active)
VALUES ((SELECT id FROM batch_sets WHERE set_code = 'umigame-soup-1'),
        '007-frozen-tag', '助けに来た少女も凍りついた', 4,
        '少年は凍りついたまま、助けが来るのをじっと待っていた。ようやく助けに来た少女は、少年のそばまで来たところで、同じようにその場で凍りついてしまった。どういうこと？',
        '少年と少女は、友だち数人と鬼ごっこの一種「氷鬼」で遊んでいた。氷鬼では、鬼にタッチされた人は「凍った」ことになってその場から動けなくなり、仲間にタッチしてもらうと「溶けて」また動けるようになる。少年は鬼にタッチされて凍り、仲間が助けに来てくれるのをじっと待っていた。少女が助けに走ってきたが、鬼は凍った少年のそばで見張っていて、少女が少年に触れる直前にタッチした。だから少女も少年のそばで凍ってしまった。凍りついたといっても本当に凍ったわけではなく、二人はこのあと別の仲間に助けてもらって、また走り回った。',
        '["少年も少女も本当に凍ってはいないし、寒い場所にいるのでもない","少年も少女も怖がってはいないし、けがや病気でもない","二人がいる場所に危険なものや恐ろしいものはない","少年と少女は友だちで、ほかにも仲間が何人か同じ場所にいる","少年が動けないのは、体のせいでも、誰かに縛られているせいでもなく、守らなければならない決まりのせいである","少年と少女が何をしていて、なぜ動けないのかは、この問題の答えの核心である（正解宣言のとき以外は補足で言わない）","少年が凍りついたのは、ある一人の相手に体をさわられたからで、その相手はまだ少年の近くにいる","少女が凍りついたのも、同じ相手に体をさわられたからである","少女が来てくれたことは、少年にとってうれしいことだった","別の仲間が二人の体にさわれば、二人はまた動けるようになる","このあと二人は元気に走り回っていて、悲しい出来事は何も起きていない","場所（校庭か公園か）・季節・時刻・二人の年齢は問題に関係ない"]',
        '[{"q":"少年は本当に凍っていますか？","a":"いいえ"},{"q":"寒い場所での出来事ですか？","a":"いいえ"},{"q":"少年は怖くて動けないのですか？","a":"いいえ"},{"q":"少年はけがや病気で動けないのですか？","a":"いいえ"},{"q":"少年は誰かに縛られていますか？","a":"いいえ"},{"q":"少年のそばに危ないものがありますか？","a":"いいえ"},{"q":"少年が動けないのは、決まりを守っているからですか？","a":"はい"},{"q":"少年と少女は遊んでいますか？","a":"はい"},{"q":"鬼ごっこの仲間ですか？","a":"はい"},{"q":"少年は誰かに体をさわられて凍りついたのですか？","a":"はい"},{"q":"少女も同じ人にさわられたのですか？","a":"はい"},{"q":"少女は少年を助けられませんでしたか？","a":"はい"},{"q":"別の仲間がさわれば、二人はまた動けるようになりますか？","a":"はい"},{"q":"少年と少女は仲が悪いのですか？","a":"いいえ"},{"q":"場所が校庭か公園かは重要ですか？","a":"関係ない"},{"q":"季節は重要ですか？","a":"関係ない"},{"q":"二人の年齢は重要ですか？","a":"関係ない"},{"q":"二人は氷鬼をしていて、少年は鬼にタッチされて動けなくなり、仲間の助けを待っていた。助けに来た少女も鬼にタッチされて、少年のそばで動けなくなった。","a":"正解"}]',
        '助けに来た子も凍りついた', '「はい / いいえ / 関係ない」で答えられる質問をコメントしてね。出題者が全部返事します',
        '{"problem":"少年は凍りついたまま、助けが来るのをじっと待っていた。ようやく助けに来た少女は、少年のそばまで来たところで、同じようにその場で凍りついてしまった。どういうこと？","rule":"はい、いいえ、関係ない、で答えられる質問をコメントしてね。全部返事するよ。"}',
        '[{"role":"questioner","text":"少年は本当に凍ってる？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"怖くて動けないの？"},{"role":"master","text":"いいえ。"},{"role":"questioner","text":"動けないのは決まりのせい？"},{"role":"master","text":"はい！"}]',
        '{"master":{"intro":"質問してみて！","outro":"何度でも答えるよ。コメントで質問！"},"jr":{"outro":"面白かったら、いいね、フォローよろしくね！"}}',
        'A stylized 1990s Japanese OVA anime background painting (hand-painted cel-era background art, poster-color textures, clean shapes, thick brush-like outlines on key objects). Mid-key lighting: moonlight, lamps or candlelight keep the whole scene clearly visible, NOT dark.

Scene: A boy standing perfectly still on an open sunny playground, arms held slightly out from his sides as if he cannot move, looking hopefully into the distance; a girl running toward him from far away; a low fence and a few trees in the background, bright daytime, no other people.

Vertical 9:16 composition (1024x1536). No text, no letters, no numbers, no logos, no signs. Depict only the scene described in the problem statement; do not depict any clue to the story''s hidden truth. People: only the persons who appear in the problem, plus at most one distant silhouette. Keep the upper 55% of the image calm and simple (sky, wall, ceiling, window) so that text cards can be overlaid there.',
        '【探偵カメロックのウミガメのスープ】
凍りついたまま助けを待っていた少年。ようやく助けに来た少女も、少年のそばで同じように凍りついてしまいました。
...
#ウミガメのスープ #水平思考 #推理クイズ #なぞなぞ #謎解き #クイズ #AIart',
        '完全オリジナル（既存問題の転載・改変ではない）。作問法は note 記事 https://note.com/suekai0217/n/n35128e606a9b の4 ステップ（モチーフ → 連想 → 言い方を変える → 不思議にする）と良い問題の 3 条件（コアが明確・動線がある・現実離れしない）に従う。着想の型は research.md（Codex Web リサーチ台帳）を参照。 型: 意味誤誘導型。モチーフ「氷」（作問スキル umigame-problem-writer の抽選 3 語〔氷・花火・くしゃみ〕から選択。花火は「音が光より遅れる」が U15 と同じ遅延構造・「朝の号砲」は地域慣習・煙や型物花火は語の仕掛けなし、くしゃみは語の仕掛けが同音〔こしょう・ほこり〕か大人の迷信で不成立）→ 連想「凍りつく（慣用句）・氷鬼」→ 具体化（凍りついたまま助けを待つ = 氷鬼で鬼にタッチされて仲間を待つ）→ 常識「助けに来た者は凍りつかない」の逆（助けに来た少女も凍りつく）。着想元の既存問題なし（台帳に遊びのルールをコアにした行はない。U12〔人形を人と読ませる〕とは慣用句の誤読という点で構造が異なる）。捨てた案: 滑る〔試験に滑る → 氷で滑る。第一義が氷で誤読が強制されない〕/ 真夏に毛布をかけて氷を運ぶ〔常識の逆だけで語の仕掛けなし〕/ 氷を入れても薄くならないジュース〔氷 = 凍らせたジュース。落差が小さい〕/ だるまさんがころんだ〔言葉で全員が凍りつく案は「はいチーズ」でも成立し正解が一つに定まらない〕。', 1);
