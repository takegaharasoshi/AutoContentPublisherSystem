...
CORE = {
    ...
    "U27": ["人生ゲーム", "駒", "ピン", "ボードゲーム", "すごろく", "ルーレット", "盤"],
    "U12": ["人形", "ひな", "雛", "五人囃子", "段飾り", "お祝い", "ひな祭り"],
    "U13": ["タイムカプセル", "本人", "同一人物", "自分自身", "未来の自分", "埋め", "同窓会", "掘り"],
    "U14": ["見習い", "弟子", "修行", "一人前", "人間", "職人"],
    "U16": ["氷鬼", "鬼ごっこ", "鬼", "タッチ", "遊", "ルール"],
    "U18": ["消せる", "フリクション", "熱", "透明", "ドライヤー", "インク", "こする", "摩擦"],
    "U20": ["娘", "子ども", "子供", "練習", "習い", "つっかえ", "毎晩", "リビング", "間違えて弾"],
    "U21": ["種", "飛ばし", "吐", "吹き", "縁側", "芽"],
    "U22": ["育った", "生家", "実家", "住んでいた家", "背丈", "背比べ", "柱の傷", "自分の家"],
    "U23": ["お釣り", "釣り銭", "取り出し口", "自販機", "自動販売機", "入れておい", "こっそり"],
    "U24": ["時計代わり", "目印", "合図にし", "時刻を決め", "時間を決め", "見て家を出"],
    "U25": ["将棋", "一手", "参りました", "投了", "盤", "駒", "指し", "一年に"],
