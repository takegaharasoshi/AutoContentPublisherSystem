...
| 15-7〜15-12（15-6 を除く投入・定型ステップ） | **Opus 5** / high（定型の既定。CDK 小修正は Claude が直接実施・詰まった場合のみ Fable 5 へ切替。15-12 の設計課題リスト棚卸しは Fable 5 でも可） | なし（外部作業・実 API の対話的作業・docs のため委譲不向き） |
