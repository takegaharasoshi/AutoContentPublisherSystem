...
| 16-2 問題ストック初期整備 | Opus 5 / high（問題の質・書き直しの判断で詰まったら Fable 5 へ切替） | なし（Web リサーチ + 日本語の質の判断のため委譲不向き） |
